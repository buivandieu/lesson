...
import com.vti.service.IReportsService;
...
public class ReportsController {
	...
	@GetMapping()
	public Page<ReportsDTO> getAllDepartments(
			Pageable pageable
//			@RequestParam(name = "search", required = false) String search,
			) {
		Page<Reports> entityPages = service.getAllReportss(pageable);

//		 convert entities --> dtos
		List<ReportsDTO> dtos = modelMapper.map(
				entityPages.getContent(), 
				new TypeToken<List<ReportsDTO>>() {}.getType());
//		
////		// add HATEOAS
...
////		}
//	
	Page<ReportsDTO> dtoPages = new PageImpl<>(dtos, pageable, entityPages.getTotalElements());
...
//		
//		dto.add(linkTo(methodOn(ReportsController.class).getDepartmentByID(id)).withSelfRel());
//
//		return dto;
//	}
//
