...
public class AccountSpecification {
	...
	public static Specification<Employees> buildWhere(String search, AccountFilterForm filterForm) {
		
		Specification<Employees> where = null;
...
class CustomSpecification implements Specification<Employees> {
